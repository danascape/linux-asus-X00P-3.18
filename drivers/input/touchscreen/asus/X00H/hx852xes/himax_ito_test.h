...
#define ITO_DEBUG_EN
#define ITO_DEBUG_DIS  //Opened the define by Rocky 20170619
//#define MutPar_DEBUG //Opened the define by Rocky 20170619
//#define VR_DEBUG //Opened the define by Rocky 20170619
...
int8_t mutual_key_dev_fail_upper = 30;	//30%
int8_t mutual_key_dev_fail_lower = -30;	//-30%
/*******************************/
...
uint8_t c3[11] = { 0xC5, 0x05, 0x1E, 0x00, 0x10, 0x17, 0x1E, 0x0B, 0x14, 0x00, 0x1F}; //c3[8] = VR7 setting
...
uint8_t c8[7] = { 0x02, 0x56, 0x05, 0x28, 0x12, 0x40, 0x00};//0xFE(02)
uint8_t c9[5] = { 0x6C, 0xAA, 0x82, 0x2D, 0x00};//0xFE(6C)
uint8_t c10[7] = { 0xE0, 0x00, 0x00, 0x1A, 0x10, 0x16, 0x1A};//0xFE(E0)
uint8_t c11[9] = { 0xE6, 0x10, 0x16, 0x1E, 0x10, 0x17, 0x1E, 0x10, 0x15};//0xFE(E6)
*/
