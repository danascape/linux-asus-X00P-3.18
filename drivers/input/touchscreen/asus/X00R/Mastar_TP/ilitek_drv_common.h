...
// zhaopengfei@wind-mobi.com 20180718 begin <<< [1/1] add the debug log
#define wind_log(fmt, arg...) printk(KERN_ERR "[wind][mstar][%s][%d] "fmt"\n", __func__, __LINE__, ##arg)
extern int tp_is_probe;	// zhaopengfei@wind-mobi.com 20180810 end   <<< [1/3] add tp probe flag
// zhaopengfei@wind-mobi.com 20180718 end   <<< [1/1] add the debug log
...
//zhaopengfei@wind-mobi.com 20180718 begin >> [8/8]add for GESTURE_WAKEUP
#define KEY_GESTURE_DOUBLE_CLICK    KEY_F21
#define KEY_GESTURE_UP              KEY_F24//KEY_F21
...
#define KEY_CUST_01 KEY_GESTURE_DOUBLE_CLICK  //up
#define KEY_CUST_02 KEY_GESTURE_UP
#define KEY_CUST_03 253
#define KEY_CUST_04 254
#define KEY_CUST_05 255   
#define KEY_CUST_06 256       //m
#define KEY_CUST_07 KEY_GESTURE_W   //w
#define KEY_CUST_08 KEY_GESTURE_C   //c
#define KEY_CUST_09 KEY_GESTURE_E   //e
#define KEY_CUST_10 KEY_GESTURE_V   //v
#define KEY_CUST_11 261       //o
#define KEY_CUST_12 KEY_GESTURE_S   //s
#define KEY_CUST_13 KEY_GESTURE_Z   //z
#define KEY_CUST_14 264             
#define KEY_CUST_15 265

//zhaopengfei@wind-mobi.com 20180718 end >> [8/8]add for GESTURE_WAKEUP
...
//mstar 20180718 begin >> [1/8]add for GESTURE_WAKEUP
#ifdef CONFIG_ENABLE_GESTURE_WAKEUP
#define PROC_ANDROID_TOUCH                    "android_touch"
#define PROC_ANDROID_TOUCH_GESTURE_EN         "SMWP"
#define PROC_ANDROID_TOUCH_GESTURE_MODE       "GESTURE"
//mstar 20180718 end >> [1/8]add for GESTURE_WAKEUP
...
#define PROC_ANDROID_TOUCH_GLOVE_MODE         "GLOVE_EN"	//zhaopengfei@wind-mobi.com add for GLOVE mode 20180719
 ...
 */
typedef enum {
    MSG28XX_SW_ID_XXXX = 0x0063,	//mstar added for update_id(99) 20180718 
