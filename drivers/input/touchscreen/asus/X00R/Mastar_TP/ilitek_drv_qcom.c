        ...
        const struct i2c_device_id *id)
{
    ...
    printk("wind_msg2836A_prob *** %s ***\n", __func__);
    
// zhaopengfei@wind-mobi.com 20180810 begin >>> [2/3] add tp probe flag
    wind_log("enter, tp_is_probe = %d", tp_is_probe);
    if(tp_is_probe)
    {
        wind_log("tp has probe");
        return -1;
    }
// zhaopengfei@wind-mobi.com 20180810 end   <<< [2/3] add tp probe flag
    if (client == NULL)
    {
