...
extern unsigned char HSD_ST7730_HX8527[];
extern unsigned char BOE_ST7730_HX8527[];
extern unsigned char BOE66_ST7730_HX8527[];
extern unsigned char BOE77_ST7730_HX8527[];
...
bool himax_ic_package_check(struct i2c_client *client)
{
            ...
            (cmd[2] == 0x25 || cmd[2] == 0x26 || cmd[2] == 0x27 || cmd[2] == 0x28))
    {
        ...
        if(!strcmp("st7703 720p video mode dsi panel",caPanelName)){
            ...
            g_i_FW_VER = HSD_ST7730_HX8527[FW_VER_MAJ_FLASH_ADDR]<<8 |HSD_ST7730_HX8527[FW_VER_MIN_FLASH_ADDR];
            g_i_CFG_VER = HSD_ST7730_HX8527[FW_CFG_VER_FLASH_ADDR];
            printk("[wjwind] current LCM = %s\n",caPanelName);
        }
        else if(!strcmp("dsi_boe55_st7703_720p_video",caPanelName))
        {
            g_i_FW_VER = BOE_ST7730_HX8527[FW_VER_MAJ_FLASH_ADDR]<<8 |BOE_ST7730_HX8527[FW_VER_MIN_FLASH_ADDR];
            g_i_CFG_VER = BOE_ST7730_HX8527[FW_CFG_VER_FLASH_ADDR];
            printk("[wjwind] current LCM = %s\n",caPanelName);
        }
		else if(!strcmp("dsi_boe66_st7703_720p_video",caPanelName))
        {
            g_i_FW_VER = BOE66_ST7730_HX8527[FW_VER_MAJ_FLASH_ADDR]<<8 |BOE66_ST7730_HX8527[FW_VER_MIN_FLASH_ADDR];
            g_i_CFG_VER = BOE66_ST7730_HX8527[FW_CFG_VER_FLASH_ADDR];
            printk("[wjwind] current LCM = %s\n",caPanelName);
        }		
		else if(!strcmp("dsi_boe77_st7703_720p_video",caPanelName))
        {
            g_i_FW_VER = BOE77_ST7730_HX8527[FW_VER_MAJ_FLASH_ADDR]<<8 |BOE77_ST7730_HX8527[FW_VER_MIN_FLASH_ADDR];
            g_i_CFG_VER = BOE77_ST7730_HX8527[FW_CFG_VER_FLASH_ADDR];
            printk("[wjwind] current LCM = %s\n",caPanelName);
        }
        else
        {
