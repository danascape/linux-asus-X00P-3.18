...
{
// zhaopengfei@wimd-mobi.com 20181122 begin	>>TP2_FW_UPDATE
#include "LTFBF0551536_LC_ASUS_A306_CID3702_5A_C35_0903-040630.i"
// zhaopengfei@wimd-mobi.com 20181122 end	>>TP2_FW_UPDATE
};

// qcom,mdss-dsi-panel-name = "dsi_boe66_st7703_720p_video";
unsigned char BOE66_ST7730_HX8527[]=
{
...
// qcom,mdss-dsi-panel-name = "dsi_boe77_st7703_720p_video";
unsigned char BOE77_ST7730_HX8527[]=
{
// zhaopengfei@wimd-mobi.com 20180925 begin	>>TP6_FW_UPDATE
#include "LTFBF0551536_LC_ASUS_A306_CID3702_5A_C35_0903-040630.i"
// zhaopengfei@wimd-mobi.com 20180925 end	>>TP6_FW_UPDATE
...
int himax_input_register(struct himax_ts_data *ts)
{
    ...
    set_bit(KEY_GESTURE_DOUBLE_CLICK, ts->input_dev->keybit);//amt_bsp add for double tap not report event at 20191113
#endif
...
static int i_update_FW(void)
{
    ...
    {
        ImageBuffer = BOE66_ST7730_HX8527;
        fullFileLength = sizeof(BOE66_ST7730_HX8527);
        printk("[wjwind] current Update = %s\n",caPanelName);
    }
	else if(!strcmp("dsi_boe77_st7703_720p_video",caPanelName))
    {
        ImageBuffer = BOE77_ST7730_HX8527;
        fullFileLength = sizeof(BOE77_ST7730_HX8527);
        printk("[wjwind] current Update = %s\n",caPanelName);
    }
    else
    {
...
// wangbing@wind-mobi.com 20180319 end   <<< [1/5] realize the touch panel gesture feature
    ...
    case EV_GESTURE_PWR:
        ...
        paul("gesture_ZA550KL: double click");
        break;
    case EV_GESTURE_01:
