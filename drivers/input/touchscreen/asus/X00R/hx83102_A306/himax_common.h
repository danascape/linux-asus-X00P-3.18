...
#endif
#define HIMAX_DRIVER_VER "0.2.6.0_ABCD1234_01"
...
struct hx_83102_ic_data
{
    ...
    bool	HX_INT_IS_EDGE;
#ifdef HX_TP_PROC_2T2R
    int hx83102_RX_NUM_2;
    int hx83102_TX_NUM_2;
#endif
};

struct hx_83102_virtual_key
{
    int index;
    int keycode;
    int x_range_min;
...
struct hx_83102_ts_data
{
    ...
    struct hx_83102_virtual_key *button;
...
// zhaopengfei@wind-mobi.com 20180410 begin >>> [1/5] realize the touch panel gesture feature
...
// zhaopengfei@wind-mobi.com 20180410 end   <<< [1/5] realize the touch panel gesture feature
...
// zhaopengfei@wind-mobi.com 20180410 begin >>> [2/5] realize the touch panel gesture feature
...
#endif
// zhaopengfei@wind-mobi.com 20180410 end >>> [2/5] realize the touch panel gesture feature

#if defined(CONFIG_TOUCHSCREEN_HIMAX_ITO_TEST)
extern uint8_t himax_ito_test(void);
#endif

extern int hx83102_irq_enable_count;
...
extern int hx83102_chip_common_probe(struct i2c_client *client, const struct i2c_device_id *id);
extern int hx83102_chip_common_remove(struct i2c_client *client);
extern int hx83102_chip_common_suspend(struct hx_83102_ts_data *ts);
extern int hx83102_chip_common_resume(struct hx_83102_ts_data *ts);
